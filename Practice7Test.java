...
public class Practice7Test {
	...
	protected boolean storeManyTest() {
		// Milan Kundera
		String[] work = { "The Joke", "Life is Elsewhere", "The Book of Laughter and Forgetting",
				"The Unbearable Lightness of Being", "Immortality", "The Festival of Insignificance" };
	...
	protected boolean increaseCapacityTest() {
		...
		String[] movies = { "The Adventures of Robin Hood", "Au revoir les enfants", "Back to the Future",
				"Beauty and the Beast", "Bicycle Thieves", "Billy Elliot", "A Day at the Races",
				"E.T. the Extra-Terrestrial", "Edward Scissorhands", "Etre et Avoir", "Finding Nemo",
				"It's a Wonderful Life", "Jason and the Argonauts", "Kes", "The Kid", "King Kong",
				"Kirikou et la sorciere", "La Belle et la Bete", "Le Voyage dans la Lune", "The 400 Blows",
				"Monsieur Hulot's Holiday", "My Life as a Dog", "My Neighbour Totoro", "The Night of the Hunter",
				"Oliver Twist", "The Outsiders", "Pather Panchali", "Playtime", "The Princess Bride",
				"Rabbit-Proof Fence", "Raiders of the Lost Ark", "The Railway Children", "The Red Balloon",
				"Romeo + Juliet", "The Secret Garden", "Show Me Love", "Singin' in the Rain",
				"Snow White and the Seven Dwarfs", "Some Like It Hot", "The Spirit of the Beehive", "Spirited Away",
				"Star Wars", "To Kill a Mockingbird", "Toy Story", "Walkabout", "Whale Rider",
				"Where Is the Friend's Home?", "Whistle Down the Wind", "The White Balloon", "The Wizard of Oz" };
		try {
			List list = new ArrayList();
